...
<head>
  ...
  <title>Tabela de Preços - Lamego | A.J.B.P. Gás</title>
...
<body class="bg-gray-100 text-gray-800 font-sans">
  ...
  <section class="relative h-[45vh] md:h-[50vh] flex items-center justify-center text-center bg-gray-900">
    <img src="img/gas-bg.png" alt="Tabela de Preços Lamego" class="absolute inset-0 w-full h-full object-cover brightness-50 blur-sm">
    <h1 class="relative z-10 text-4xl md:text-5xl font-extrabold text-white px-4">Tabela de Preços - Lamego</h1>
  </section>
  ...
  <main class="py-20 px-[10%] bg-white text-center">
    ...
    <p class="text-gray-700 mb-10 max-w-3xl mx-auto">
      A tabela abaixo apresenta os preços atualizados para a cidade de <strong>Lamego</strong>, incluindo a entrega ao domicílio.  
      ...
      <table class="min-w-full border border-gray-200 rounded-lg shadow-sm">
        ...
        <tbody class="divide-y divide-gray-200">
          ...
          <tr class="hover:bg-orange-50 transition">
            ...
            <td class="py-3 px-6 text-center font-semibold text-gray-800">25,90</td>
          </tr>
          <tr class="hover:bg-orange-50 transition">
