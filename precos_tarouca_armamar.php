...
<head>
  ...
  <title>Preços - Tarouca / Armamar | A.J.B.P. Gás</title>
...
<body class="bg-gray-200 text-gray-800 font-sans">
  ...
  <main class="relative py-16 md:py-20 px-[6%] text-center overflow-hidden">
    <div class="absolute inset-0 opacity-20 pointer-events-none" style="background-image: radial-gradient(circle at 20% 10%, rgba(255,255,255,.35), transparent 40%), radial-gradient(circle at 80% 30%, rgba(255,255,255,.25), transparent 45%), radial-gradient(circle at 40% 90%, rgba(255,255,255,.25), transparent 50%);">
    </div>
